...
@media (prefers-color-scheme: light) {
  ...
  :root .LanguageSelector-module--wrapper--f9f17 {
    --button-background: #313244 !important;
    --button-border-color: #313244 !important;
  ...
  :root .deeplLogo-module--logo--ffd7a {
    filter: brightness(0) saturate(100%) invert(57%) sepia(66%) saturate(1020%) hue-rotate(195deg) brightness(115%) contrast(96%);
  }
}
