// ==UserScript==
// @name    Userstyle (syncthing.css)
// @include    *localhost:8384*
// @include    *127.0.0.1:8384*
// @include    *0.0.0.0:8384*
// ==/UserScript==
...
@media (prefers-color-scheme: light) {
  ...
  :root .btn-primary.focus {
    background-color: rgba(203, 166, 247, 0.9) !important;
  }
  :root .btn-warning {
  ...
  :root .btn-warning.focus {
    background-color: rgba(249, 226, 175, 0.9) !important;
  }
  :root .btn-danger {
  ...
  :root .btn-danger.focus {
    background-color: rgba(243, 139, 168, 0.9) !important;
  }
  :root .modal-header {
    border-color: #313244 !important;
